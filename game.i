...
void initGame() {
    playSoundA(mus_game1, 1749550, 1);
    ...
    DMANow(3, GameOverlayTiles, &((charblock *)0x6000000)[0], 256 / 2);
    DMANow(3, GameOverlayMap, &((screenblock *)0x6000000)[22 -1], 2048 / 2);
    ...
    DMANow(3, gameBackgroundTiles, &((charblock *)0x6000000)[2], 64 / 2);
    DMANow(3, gameBackgroundMap, &((screenblock *)0x6000000)[22 -2], 2048 / 2);
    ...
    (*(volatile u16*) 0x04000050) = (1<<0) | (1<<1) | (1<<2) | (1<<4)
                | (3<<6);
    (*(volatile u16*) 0x04000054) = ((17) <<0);
...
void fade() {
    ...
    (*(volatile u16*) 0x04000054) = ((blend) <<0);
    count++;
...
# 196 "game.c"
    ...
    DMANow(3, mapTiles, &((charblock *)0x6000000)[1], 384 / 2);
}
