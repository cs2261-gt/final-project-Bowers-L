...
void initItem(Item* item, int col, int row, ItemType type) {
    ...
    shadowOAM[item->index].attr0 = (((item->screenRow) >> 4) & 0xFF) | (2<<8) | (0<<13) | (0<<14);
...
void showSelectorOnItem() {
    shadowOAM[120].attr0 = (8 & 0x1FF) | (0<<13) | (0<<8) | (0<<14);
    shadowOAM[120].attr1 = ((8 + player.currentItem*20) & 0x1FF) | (1<<14);
    shadowOAM[120].attr2 = ((10)*32+(1));
}
