...
int touchingGround() {
    return mapCollisionBitmap[((((player.worldRow + player.height - 1 + 16) >> 4))*(512)+(((player.worldCol) >> 4)))]
    || mapCollisionBitmap[((((player.worldRow + player.height - 1 + 16) >> 4))*(512)+(((player.worldCol + player.width - 1) >> 4)))];
}
